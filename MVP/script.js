document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .getElementById("show-all-necklaces")
...
function showImages(category) {
  ...
  switch (category) {
    case "rings":
      images = [
        "img/ring/eternityring.avif",
        "img/ring/fashionrings.avif",
        "img/ring/ringenhancer.avif",
        "img/ring/WeddingRings.avif",
      ];
      titles = ["Eternityring", "Fashionrings", "Ringenhancer", "WeddingRings"];
      break;
    case "earrings":
      images = [
        "img/earrings/earringjacket.avif",
        "img/earrings/fashionearrings.avif",
        "img/earrings/hoops.avif",
        "img/earrings/stdEarring.webp",
      ];
      titles = ["Earringjacket", "Fashionearrings", "Hoops", "StdEarring"];
      break;
    case "bracelets":
      images = [
        "img/bracelets/bangle bracelets.avif",
        "img/bracelets/fashion bracelets.webp",
        "img/bracelets/new arrivals.avif",
        "img/bracelets/tennisbacelets.avif",
      ];
      titles = [
        "Bangle bracelets",
        "Fashion bracelets",
    ...
    case "necklaces":
      images = [
        "img/necklaces/fashion necklace.avif",
        "img/necklaces/fashionpendant.avif",
        "img/necklaces/solitaire.avif",
        "img/necklaces/tennis necklace.avif",
      ];
      titles = [
        "Fashion necklace",
        "Fashionpendant",
